...
Source:     %{url}/archive/refs/tags/v%{major_version}-%{release_version}.tar.gz
...
%install
install -d -m 0755 %{_usrsrc}/akmods/e1000e
install -m 0644 %{buildroot}%{_usrsrc}/akmods/e1000e/kmod-e1000e.spec
